package com.example.autopartsrest.config;

import com.example.autopartsrest.filter.JWTAuthenticationTokenFilter;
import com.example.autopartsrest.security.JwtAuthenticationEntryPoint;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                ...
                .requestMatchers("/product/getImage/**").permitAll()
